...
void callback(const std_msgs::String::ConstPtr& msg)
{
  ...
  goal_0.target_pose.pose.position.x = -0.51; //1.371;
  goal_0.target_pose.pose.position.y = -0.334;//-3.225;
  ...
  goal_1.target_pose.pose.position.x = -0.582; //1.371;
  goal_1.target_pose.pose.position.y = -0.359;//-3.225;
  ...
  goal_2.target_pose.pose.position.x = -0.61; 
  goal_2.target_pose.pose.position.y = -0.367;
  
  goal_2.target_pose.pose.orientation.x = 0.0;
  goal_2.target_pose.pose.orientation.y = 0.0;
  goal_2.target_pose.pose.orientation.z = -0.147;
  goal_2.target_pose.pose.orientation.w = 0.989;
